...
const PROJECT_NAME = packageJson.name || 'biaoshu-client';
const APP_ID = packageJson.build?.appId || 'com.biaoshu.bidtool';
const PRODUCT_NAME = packageJson.build?.productName || '标枢';
