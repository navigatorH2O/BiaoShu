...
const ANALYTICS_PROJECT_NAME = 'biaoshu-client';
...
async function testGoogleImageModel(app, config) {
  ...
  const requestBody = createGoogleImageRequestBody('大字报，内容是“标枢AI老好了”', normalizeGoogleImageSize(imageConfig));
